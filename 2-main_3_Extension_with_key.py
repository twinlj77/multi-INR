...
#secret_model_and_config_dir = 'trained-models/celebahq_2'
secret_model_and_config_dir = 'trained-models/celebahq_2'

########################################################################
# config file for train StegaINR model
#config_path = "configs\config_celebahq_3.json"
config_path="configs\config_celebahq_3.json"
...
stego_weights, stego_bias = parameters_expand_generate_by_key_and_secret_model("key2.json", function_representation_secret,function_representation_stego)
