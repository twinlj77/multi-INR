...
exp_dir_secret = 'trained-models/celebahq_3'
...
exp_dir_stego = 'trained-models/celebahq_4'
...
if num_frequencies:
    ...
    frequency_matrix = torch.load('frequency_matrix_2025-03-26_21-34.pt')
...
func_secret_inr_extracted.save_data_samples_from_representation("3-yincang.png", data_converter,datatype, save_dir)
print("Sample from stego inr model with key complete !  " )
print("filename: yincang.png")
