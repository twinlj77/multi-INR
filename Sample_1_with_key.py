...
exp_dir_stego = 'trained-models/celebahq_2'
...
if num_frequencies:
    ...
    frequency_matrix = torch.load('2025-05-26_20-24-21frequency_matrix_for_inr_secret.pt')
...
func_secret_inr_extracted.save_data_samples_from_representation("yincang.png", data_converter,datatype, save_dir)
